...
def submit():
    ...
    return render_template('search.html', enumerate=enumerate, 
...
def delete_game():
    if request.method == 'POST':
        ...
        return render_template('delete.html', message=message, success=success, active_page='delete')
    else:
        return render_template('delete.html', active_page='delete')
...
def update_game():
    if request.method == 'POST':
        ...
        return render_template('update.html', message=message, success=success, active_page='update')
    else:
